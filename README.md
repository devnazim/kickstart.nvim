...
- on Linux and Mac
```sh
git clone https://github.com/devnazim/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```

- on Windows (cmd)
```
git clone https://github.com/devnazim/kickstart.nvim.git %userprofile%\AppData\Local\nvim\ 
```

- on Windows (powershell)
```
git clone https://github.com/devnazim/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
